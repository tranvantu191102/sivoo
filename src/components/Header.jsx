    ...
    return (
        ...
        >
            <div className="flex items-center justify-between px-6 h-full ">
                ...
                ${activeMobile ? 'px-6   inset-0 top-0 left-0 flex-col bg-dark-primary-bg w-[100%] z-[999] translate-x-0 opacity-100 visible pointer-events-auto'
                        : ' invisible pointer-events-none  -translate-x-28 opacity-0 md:visible md:pointer-events-auto md:opacity-100 md:translate-x-0'}`}>
                    <div className="flex items-center justify-between pt-7 md:hidden ">
                        <div className="">
                            <img src={logo} alt="" />
                        </div>
                        <div className="block md:hidden text-base cursor-pointer ">
                            <FontAwesomeIcon icon={faX} onClick={() => setActiveMobile(false)} />
                        </div>
                    </div>
                    <div className="font-light text-base text-current mr-8 py-4  md:py-0">
                    ...
                    <div className="font-light text-base text-current flex items-center justify-start md:justify-center  py-4  md:py-0 cursor-pointer">
